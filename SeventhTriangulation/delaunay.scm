  ...
  (let ((old-triangle-1 (edge-triangle-1 edge))
	...
	(let ((edge-1
		...
		(make-edge
		  ...
		  new-triangle-4 triangle-3))
	      (edge-4
		(make-edge
		  (make-segment vertex-4 vertex-1)
		  new-triangle-2 triangle-4)))
	  (legalize-edge edge-1 triangulation)
	  (legalize-edge edge-2 triangulation)
	  (legalize-edge edge-3 triangulation)
...
(define (legalize-edge edge triangulation)
  ...
  (define (flip-segment! segment triangle-up triangle-down vertex-4)
	...
	(triangle-adjacent-triangles-set!
	  triangle-left
	  triangle-right triangle-4 triangle-1)
	(triangle-adjacent-triangles-set!
	  triangle-right
	  triangle-3 triangle-left triangle-2)
	(copy-triangle triangle-right triangle-up)
	(copy-triangle triangle-left triangle-down)
	(let ((edge-1
		(make-edge
		  (make-segment vertex-1 vertex-4)
		  triangle-left triangle-4))
	      (edge-2
		(make-edge
		  (make-segment vertex-3 vertex-4)
		  triangle-right triangle-3)))
	  (legalize-edge edge-1 triangulation)
	  (legalize-edge edge-2 triangulation)))))

  (display "Looking for ilegal edges\n")
  (let ((triangle-up (edge-triangle-1 edge))
    ...
    (display-sub-triangle triangle-up)
    (display-sub-triangle triangle-down)
    (pp (segment-from segment))
    (pp (segment-to segment))
...
(define (change-triangle-pointers target-triangle old-triangle new-triangle)
  (if (triangle? target-triangle)
    (cond ((same-triangles? old-triangle (triangle-triangle-1 target-triangle))
	   (triangle-triangle-1-set! target-triangle new-triangle))
	  ((same-triangles? old-triangle (triangle-triangle-2 target-triangle))
	   (triangle-triangle-2-set! target-triangle new-triangle))
	  ((same-triangles? old-triangle (triangle-triangle-3 target-triangle))
	   (triangle-triangle-3-set! target-triangle new-triangle)))))
...
(define (triangle-adjacent-triangles-set!
	  triangle triangle-1 triangle-2 triangle-3)
  (triangle-triangle-1-set! triangle triangle-1)
  (triangle-triangle-2-set! triangle triangle-2)
  (triangle-triangle-3-set! triangle triangle-3))
