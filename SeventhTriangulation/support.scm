...
(define (same-triangles? triangle-1 triangle-2)
  (if (and (triangle? triangle-1) (triangle? triangle-2))
    (let ((vertex-1-1 (triangle-vertex-1 triangle-1))
      ...
      (and (or (equal? vertex-1-1 vertex-1-2)
	       (equal? vertex-1-1 vertex-2-2)
	       (equal? vertex-1-1 vertex-3-2))
	   (or (equal? vertex-2-1 vertex-1-2)
	       (equal? vertex-2-1 vertex-2-2)
	       (equal? vertex-2-1 vertex-3-2))
	   (or (equal? vertex-3-1 vertex-1-2)
	       (equal? vertex-3-1 vertex-2-2)
	       (equal? vertex-3-1 vertex-3-2))))
